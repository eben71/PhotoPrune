...
| 2026-01-05 | Store OAuth tokens encrypted at rest for feasibility probes.                                                                      | Prevents plaintext token storage during probes.                                           | Approved |
| 2026-01-05 | Keep feasibility probe code isolated from MVP product code.                                                                       | Prevents experimental implementation details from leaking into production paths.          | Approved |
