...
Real Google login, the Google Photos Picker API session/media-items flow, timeout behavior, and exact-photo Google Photos link-out/reference checks belong to `docs/testing/MANUAL_MVP_DEMO_CHECKLIST.md`.
